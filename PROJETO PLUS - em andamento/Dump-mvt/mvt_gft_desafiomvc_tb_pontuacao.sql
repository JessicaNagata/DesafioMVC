...
CREATE TABLE `tb_pontuacao` (
  `id_pontuacao` bigint NOT NULL AUTO_INCREMENT,
  `atividade` bit(1) DEFAULT NULL,
  `atraso` bit(1) DEFAULT NULL,
  `presenca` bit(1) DEFAULT NULL,
  PRIMARY KEY (`id_pontuacao`),
  CONSTRAINT `FKjsi44h72f553iodj96cl8215e` FOREIGN KEY (`id_pontuacao`) REFERENCES `raking_tb` (`id_raking`)
